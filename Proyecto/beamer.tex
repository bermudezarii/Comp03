...
static int read_file ( const char * , char * 
, int * ) ; 
...
init_maze_mutex ( ) ; 
create_maze ( string , maze_size [ 0 ] , maze_size 
\end{minted}
\end{frame}
\begin{frame}[fragile]
\frametitle{C\'odigo}
...
pthread_create ( & printing , NULL , keep_printing_maze 
, NULL ) ; 
pthread_create ( & manager , NULL , check_for_threads 
, NULL ) ; 
...
( ( __nothrow__ , __leaf__ ) ) ; \end{minted}
\end{frame}
\begin{frame}[fragile]
